...
class MyRobot(wpilib.SampleRobot):
    ...
    def operatorControl(self):
        ...
        while not self.isEnabled():
            ...
            self.fixedLargeValue = ((max(0.00001,self.largeDistance.getVoltage()))/22.73)**(1/-0.7533)
            self.fixedSmallValue = ((max(0.00001,self.smallDistance.getVoltage()))/7.330)**(1/-0.7685)
